        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 text-right">
                    <a href="https://cbseresults.nic.in" target="_blank" class="mt-2 h3 d-block text-white"> https://cbseresults.nic.in</a>
                    <span class="d-block h5 text-white">Examination Results 2025</span>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12 text-center">
                            <h5 class="font-weight-bold ">
                                <span> Senior School Certificate Examination (Class XII) Results 2025 </span>
                            </h5><hr />
                        </div>
                    </div>
